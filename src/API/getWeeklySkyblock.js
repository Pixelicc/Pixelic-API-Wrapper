...
/**
 * Retrieve the weekly skyblock stats of a specific player (Returns the total stats from the last check).
 * @constructor
...
module.exports = async function (player) {
  ...
  const res = await this.makeRequest(`https://api.pixelic.de/player/${player}/weekly`);
