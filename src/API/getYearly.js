...
/**
 * Retrieve the yearly stats of a specific player (Returns the total stats of the first found datapoint of the current year).
 * @constructor
...
module.exports = async function (player) {
  ...
  const res = await this.makeRequest(`https://api.pixelic.de/player/${player}/yearly`);
